...
variable "ecs_task_execution_role_name" {
  ...
  default = "DataStreamEcsTaskExecutionRole"
}
...
variable "ops_stream_image" {
  ...
  default     = "XXXXXXXX.dkr.ecr.ap-southeast-1.amazonaws.com/dev-app1:2.0.0"
}
...
variable "ops_reader_image" {
  description = "Docker image to run in the ECS cluster"
  default     = "XXXXXXXX.dkr.ecr.ap-southeast-1.amazonaws.com/dev-app2:2.0.0"
}
